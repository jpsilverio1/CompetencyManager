...
class CreateLearningAidFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        {
            $rules['name.'.$key] = 'required|min:2|unique:learningaids,name';
        }
    ...
    public function messages()
    {
        ...
        foreach($this->request->get('name') as $key => $val)
        {
            ...
            $messages['name.'.$key.'.unique'] = 'Um treinamento já foi cadastrado com este nome. Por favor utilize outro nome.';
